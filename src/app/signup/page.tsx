        ...
        <main className="flex relative bg-primaryDark items-center justify-center px-8 py-8 pb-[30vh] sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-5">
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              <a className="inline-flex main-logo  size-16 items-center justify-center rounded-full bg-lightGray text-primaryDark sm:size-20">
                <span className="sr-only">Home</span>
                ...
                <svg
                  ...
                  fill="#354F52"
                  xmlns="http://www.w3.org/2000/svg"
                  className="logo-svg cursor-pointer"
                >
                  <path
                    className="ccustom logo-path"
                    fillRule="evenodd"
