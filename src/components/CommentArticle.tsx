...
const CommentArticle = ({ setCommentsArticle, idArt }: CommentArticleProps) => {
  ...
  const onSubmit: SubmitHandler<data> = async (data) => {
    if (userData) {
      const body = {
        ...
        article: idArt,
        commented: `${userData.documentId}${idArt}`,
      };
      addComment(body)
        .unwrap()
        .then((fulfilled) => {
    ...
    <div className="relative z-20 flex justify-center">
      ...
      >
        ...
        <div className="popup  flex-col px-6 pt-4 pb-4 relative z-30 bg-lightGraySec shadow-xl  rounded-xl w-[90%] sm:w-[500px] h-fit border-2 border-t-0 border-r-0 border-primaryDark">
          ...
          >
            <textarea
              {...register("commet", { required: "Comment is required" })}
