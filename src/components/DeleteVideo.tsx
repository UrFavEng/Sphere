import { useDeleteVideoMutation } from "@/app/store/apislice";
import React from "react";
import { PulseLoader } from "react-spinners";
import Swal from "sweetalert2";
interface DeleteVideoProps {
  setDeleteViddeo: (val: boolean) => void;
  id: string;
}
const DeleteVideo = ({ setDeleteViddeo, id }: DeleteVideoProps) => {
